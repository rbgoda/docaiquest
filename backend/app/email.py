...
def send_verification_email(*, to: str, name: str | None, verify_url: str) -> bool:
    ...
    subject = "Verify your email · DocAIQuest"
    html = f"""\
<div style="font-family:-apple-system,Segoe UI,sans-serif;max-width:440px;margin:0 auto;color:#1a1a1a">
  ...
  <p>{greeting}</p>
  <p>Thanks for signing up for <b>DocAIQuest</b>. Please confirm your email to finish setting up your account.</p>
  ...
  <p style="color:#999;font-size:12px;margin-top:28px">If you didn't create a DocAIQuest account, you can ignore this email.</p>
</div>"""
    text = f"{greeting}\n\nConfirm your DocAIQuest email by opening this link:\n{verify_url}\n\nIf you didn't sign up, ignore this email."
