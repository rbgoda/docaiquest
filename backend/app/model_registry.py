...
REGISTRY: dict[str, ModelOperation] = {
    ...
    "schema_architect": ModelOperation(
        id="schema_architect",
        ...
        editable=True,
        cost_tier="paid",
        description="AI-powered schema designer: proposes field schemas for document types. Fallback from schema_autopilot_model.",
    ),
    ...
    "chat_doc_agent": ModelOperation(
        id="chat_doc_agent",
        label="Document Agent (ReAct)",
        category="Chat & Agent",
        ...
        editable=True,
        cost_tier="cheap",
        description="Tool-using ReAct agent for single-document chat. Uses search_chunks, get_extracted_field, etc.",
    ),
    "chat_workspace_agent": ModelOperation(
        id="chat_workspace_agent",
        label="Workspace Agent (ReAct)",
        category="Chat & Agent",
        default_model="dashscope/qwen-plus",
        env_var="DOCAIQ_INTELLIGENCE_MODEL",
        provider="dashscope",
        editable=True,
        cost_tier="cheap",
        description="Tool-using ReAct agent for cross-document workspace chat. Same model as doc agent.",
    ),
